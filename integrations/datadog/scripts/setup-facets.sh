...
echo "├──────────────────┼───────────────────────┼──────────────────────────────────┤"
echo "│ @event_type      │ FSxN Audit            │ Windows EventID (4663/4660/etc)  │"
echo "│ @operation_name  │ FSxN Audit            │ Human-readable operation         │"
echo "│ @user            │ FSxN Audit            │ DOMAIN\\username                  │"
echo "│ @svm             │ FSxN Audit            │ Storage Virtual Machine name     │"
echo "│ @path            │ FSxN Audit            │ File/folder path accessed        │"
echo "│ @client_ip       │ FSxN Audit            │ Source IP address                │"
echo "│ @operation       │ FSxN Audit            │ ONTAP operation type             │"
echo "│ @result          │ FSxN Audit            │ Audit Success / Audit Failure    │"
echo "└──────────────────┴───────────────────────┴──────────────────────────────────┘"
echo ""
echo "Tip: Use 'FSxN Audit' as the Facet Group to keep them organized"
