...
FSxN 監査ログを可視化する Splunk ダッシュボードを作成し、スクリーンショットを撮影して E2E 検証エビデンスとして保存する手順書。
...
1. **ダッシュボードタイトル**: `FSxN Audit Log Overview` が表示されている
...
<dashboard version="1.1">
  <label>FSxN Audit Log Overview</label>
...
- [ ] ダッシュボードが作成された（タイトル: `FSxN Audit Log Overview`）
